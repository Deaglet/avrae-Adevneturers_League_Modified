...
class ThankYou(commands.Cog):
    ...
    async def Homegrown(self, ctx):
        ...
        embed.set_footer(text="Thank you for being a Nitro Supporter!", icon_url="https://raw.githubusercontent.com/DiscordiaWiki/wiki/master/uploads/icons/nitro.png")
